...
void VGui_CreateGlobalPanels( void )
{
	...
	if (!BaseModPanel->GetPanel())
	{
		BaseModPanel->Create(NULL);
	}
	if (g_pBaseModPanel && g_pBaseModPanel->GetGameUI())
	{
		g_pBaseModPanel->GetGameUI()->SetMainMenuOverride(g_pBaseModPanel->GetVPanel());
	}
